sap.ui.controller('ContactBook.indexShell', {
  ...
  _getView : function () {
    ...
    * Use this to show the statics chart page
    * 
    * @memberOf ContactBook.indexShell
    */
  _showStatics : function () {
   ...
   * Used this to show the index page
   * 
   * @memberOf ContactBook.indexShell
   */
  _showIndex : function () {
   ...
   * Use this to show the contact-book page
   * 
   * @memberOf ContactBook.indexShell
   */
  ...
  itemSelected : function (evt,controller) {
    ...
    views.contactBook : this._showContactBook(),
      statics : this._showStatics(),
      other : this._showStatics()
    };
